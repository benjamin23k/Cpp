...
/*
    Más ejemplos de sintaxis y problemas en C++
*/
...
// --- Declaración global para friend ---
class Amigo;
void mostrarSecreto(const Amigo&);
...
// Definición de la clase Contador antes de su uso
class Contador {
public:
    static int cuenta;
    Contador() { cuenta++; }
...
int main2() {
    ...
    ulong xlong = 123456;
    entero y = 42;
    cout << "typedef ulong: " << xlong << ", using entero: " << y << endl;

    // --- Problema: Uso de static ---
    ...
    // No se permite definir un namespace dentro de una función.
    cout << "Namespace Ejemplo::valor: " << Ejemplo::valor << endl;
    ...
    // Ya definida fuera de main2, solo usarla aquí
    Contador cA, cB;
...
salto:
    ...
    */
    ...
    // (Eliminado el bloque duplicado para evitar errores de redefinición)
